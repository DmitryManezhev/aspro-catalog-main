...
<div class="catalog-block__info-title linecamp-10 height-auto-t600 font_15 font_14--to-600">
	<p class="Detail_text"> <?=$Detailtext;?> </p></div>
						...
						<?if (
							...
							<div class="catalog-block__info-bottom <?=($arCurrentOffer ? 'catalog-block__info-bottom--with-sku' : '');?>">
								<div class="line-block line-block--8 line-block--8-vertical flexbox--wrap flexbox--justify-center">
									<div class="line-block__item js-btn-state-wrapper flex-1 <?=($arCurrentOffer ? 'hide-600' : '');?> <?=(!$arBasketConfig['HTML'] ? ' hidden' : '');?> catalog-wide-button">
